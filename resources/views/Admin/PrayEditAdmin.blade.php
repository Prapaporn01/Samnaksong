                 ...
                 <div class='form-group'>
                            <div class='col-md-12 col-xs-12 '>
                              <div class="alert alert-info">     
                                หากต้องการแก้ไขไฟล์บทสวดมนต์และไฟล์เสียง ให้กดปุ่มลบไฟล์จากนั้นทำการเลือกไฟล์ใหม่ <br>หากไม่ต้องการแก้ไขไฟล์ ให้ข้ามขั้นตอนนี้ไป
                              </div>
                            </div>
                        </div>
                
                <div align="center" >ไฟล์บทสวดมนต์เดิม : {{$pray->pray_detail}} &nbsp; ไฟล์เสียงเดิม :{{$pray->pray_sound}} </div><br>
