...
<body>
            <div class="col-md-11 col-xs-11" >
                <ul class="breadcrumb" style="padding-top: 8px;margin-bottom: 0px;margin-left: 150px;margin-right: 25px;">
                    ...
                    <li><a href="{{ url('/DirectoryMainUser')}}">ทำเนียบเจ้าอาวาส</a></li>
                    <li class="active">พระศิริมงคล</li>
                </ul>
            </div>
...
<body>
            ...
            <div class="col-md-12">
                    ...
                    <br>
                    <br>
                    <center style="color:black; font-size:18px;"><b><fontTh>พระศิริมงคล</fontTh></b></center>
                    <br>
                    <br>
                    ...
                    <div class="col-md-12">
                        ...
                        <font color="black"><fontTh><b>ช่วงเวลาที่เป็นเจ้าอาวาส : </b>พ.ศ. ๒๕๐๒-๒๕๐๘</fontTh></a></font><br>
                        <font color="black"><fontTh><b>ฉายาทางธรรม : </b>ธัมชโย (ผู้ชนะด้วยธรรม)</fontTh></a></font><br>
                        <font color="black"><fontTh><b>ตำแหน่ง :</b> ผู้ช่วยเจ้าคณะตำบล</fontTh></a></font><br>

                        <div align="left" style="color:black; font-size:14px;"><fontTh>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;พระศิริมงคล ท่านได้อุทิศชีวิตให้กับงานเผยแผ่พระพุทธศาสนา ท่านเป็นกำลังสำคัญในการจัดอบรม ทั้งแก่อาจารย์ นักเรียน นักศึกษา ตลอดจนผู้สนใจปฏิบัติธรรมทั่วไป</fontTh></div>
                     <br>
                    </div>
