...
<body>
            <div class="container">
                  <ul class="breadcrumb">
                      ...
                      <li class="active"><a href="javascript:void(0);" style="font-size:18px;"><fontTh>ข่าวประชาสัมพันธ์</fontTh></a></li>
                  </ul>          
            </div>
...
<body>   
    ...
    <div class="col-md-12">
                ...
                <br>
                <br>
                <center style="color:#330033; font-size:22px;"><b><fontTh>ข่าวประชาสัมพันธ์</fontTh></b></center>
                <br>
            <div class="main">
                  ...
                  <div class="body">
                    <div class="left_resize">
                      ...
                      <div class="left">
                        <div class="col-md-4">
                          <div align="center"><img src="{{ 'images/resize/'.$row->newsmain_pic }}" width="150" height="150"></div>
                        </div>
                        <div class="col-md-8">
                        <p><span style="color:#336699; font-size:18px;">{{$row->news_title}}</span><br><div style="color:black; font-size:16px;">{{$row->news_description}}</div></p>
                        <p><a href="{{ url('/NewsMainUser/'.$row->news_id)}}" class="btn btnNews" style="color:#666633;float:right;"><fontTh><b>อ่านข่าวเพิ่มเติม</b></fontTh></a></p>
                        </div>
                      </div>
                      @endforeach
