...
<body>   
    ...
    <div class="col-md-12">
                ...
                <br>
                <br>
                <center style="color:black; font-size:18px;"><b><fontTh>ข่าวประชาสัมพันธ์</fontTh></b></center>
                <br>
            <div class="main">
                  ...
                  <div class="body">
                    <div class="left_resize">
                      ...
                      <div class="left">
                        ...
                        <div class="col-md-8">
                        <p><span>{{$row->news_title}}</span><br>{{$row->news_description}}</p>
                        <p><a href="{{ url('NewsUser')}}" class="btn btnNews">อ่านข่าวเพิ่มเติม</a></p>
                        </div>
                      </div>
                      @endforeach
